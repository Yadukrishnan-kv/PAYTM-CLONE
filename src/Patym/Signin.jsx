...
function Signin() {
  return (
    <div>
         ...
         <div className="main2">
          <div><p>By signing in, you agree to our privacy policy and terms of use</p></div>
         </div>
         <div className="main3">
          <div><p>To create an account download Paytm App</p></div>
          <div className='main3img'><img src="https://accounts.paytm.com/oauth-js-sdk/c6be4705ad32e081df3d6816faa4555a.svg" alt="" /></div>
          <div className='main3img2'><img src="https://accounts.paytm.com/oauth-js-sdk/c0e2feaef05109ec2b59fd0e577ed6a9.svg" alt="" /></div>
         </div>
         </div>
